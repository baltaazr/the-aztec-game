...
namespace the_aztec_game
{
    class Initializers
    {
        public static Room[] initTempleMap(List<Item> items)
        {
            ...
            using (StreamReader r = new StreamReader("resources/map.json"))
            {
        ...
        public static List<Enemy> initEnemies()
        {
            ...
            using (StreamReader r = new StreamReader("resources/enemies.json"))
            {
                ...
                foreach (var jsonMonster in jsonMonsters)
                {
                    ...
                    Enemy monster = new Enemy(monsterValue.name.ToString(), monsterValue.description.ToString(), monsterStats, monsterValue.image.ToString());
                    enemies.Add(monster);
